...
function runPreCompact (input, opts = {}) {
  ...
  savePending(root, hookInput.sessionId, formatBody(pairs))
...
module.exports = { run, runPreCompact, formatModelName, resolveCoauthor, readClaudeAttribution, resolveTranscriptPath }
